...
# load park and rail geojson data 
...
# remove the point geometry from rail_gpd
...
# create park centroid coord gpd for distance calculation later (park centroid and tack lines)
...
for name_idx in range(len(track_name)):
    ...
    for i, line in enumerate(lines):
        # find the shortest distance between the current line and all the parks
        ...
        # if the park is already within the 200m range with another line segment of the train track
...
# find the train track with the largest area of parks 
